...
const ProjectCard = ({ project, onClick }) => {
  return (
    <div 
      onClick={onClick}
      className="relative h-full min-h-100 bg-white dark:bg-gray-900 rounded-2xl shadow-md overflow-hidden cursor-pointer transition duration-300 hover:-translate-y-1 hover:scale-105 transform"
    >
      {/* Thumbnail */}
